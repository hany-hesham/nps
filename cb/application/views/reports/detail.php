				...
				<tbody>
					<?php foreach ($participants as $participant): ?>
						<tr class="<?php  if ($participant['recommend'] >= 0 && $participant['recommend'] <= 6) {
							...
							<td><?php echo $participant['lang_name'] ?></td>
							<td><?php echo $participant['telephone'] ?></td>
							<td><?php echo $participant['comment'] ?></td>
							<td><?php echo $participant['timestamp'] ?></td>
						</tr>
					<?php endforeach; ?>
						<tr class="info center">
							<td colspan="7">Total Number of Participants</td>
							<td colspan="3"><?php echo $total ?> Guests</td>
						</tr>
				</tbody>
			</table>
		</div>
