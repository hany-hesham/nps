  ...
  <div class="dark" style="background-color: #43BFC7; min-height: 500px;">
    <div class="content-wrap" style="margin-left: 2%; margin-right: 2%; font-size:24px;">
      <form  action="" method="POST" id="form-submit" enctype="multipart/form-data" class="form-div span12" accept-charset="utf-8">
        ...
        <br>
        <br>
        <input type="submit" name="submit1" value="<?php echo $translation['next'] ?>" class="btn btn-success" style="border-color: white; background-color: white; color:#43BFC7 ; text-align: center; float: left; position: absolute; margin-left: 70%; width: 20%; height: 10%; padding-top: ; font-size: 12px;">
        <input type="submit" name="submit" value="<?php echo $translation['cancel'] ?>" class="btn btn-success" style="border-color: white; background-color: white; color:#43BFC7 ; text-align: center; float: left; position: absolute; margin-left: 10%; width: 20%; height: 10%; padding-top: ; font-size: 12px;">
      </form>
    </div>
  </div>
</section>
